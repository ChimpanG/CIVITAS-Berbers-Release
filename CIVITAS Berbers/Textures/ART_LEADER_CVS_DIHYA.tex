...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Network\Civ VI Modding\Textures\Berber\ART_LEADER_CVS_DIHYA.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3500093330</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="ART_LEADER_CVS_DIHYA.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="ART_LEADER_CVS_DIHYA"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
