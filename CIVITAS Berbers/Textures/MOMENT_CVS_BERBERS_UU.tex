...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Saturnine\Downloads\MOMENT_CVS_BERBERS_UU.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4294769625</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="MOMENT_CVS_BERBERS_UU.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="MOMENT_CVS_BERBERS_UU"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
