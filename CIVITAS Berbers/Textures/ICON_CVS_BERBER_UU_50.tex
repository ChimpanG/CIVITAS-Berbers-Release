...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Network\Civ VI Modding\Textures\Berber\UU\ICON_CVS_BERBER_UU_50.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3966393591</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="ICON_CVS_BERBER_UU_50.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="ICON_CVS_BERBER_UU_50"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
